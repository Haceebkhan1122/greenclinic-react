...
import "./mobileFilterInvoiceModal.scss"
import API from "../../../services/httpInstance";
import { toast } from "react-toastify";
import dayjs from "dayjs";

const MobileFilterInvoiceModal = ({ filterShow, setStatus, status, setSelectedDate, selectedDate, handleFilterClose, getLabTests }) => {
    ...
    return (
        <Modal show={filterShow} onHide={handleFilterClose} centered className="mobileFilterInvoiceModal">
                <Modal.Body>
...
export default MobileFilterInvoiceModal;