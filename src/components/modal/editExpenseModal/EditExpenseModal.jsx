...
const EditExpenseModal = ({ showEditExpense, handleEditClose, getExpenses,singleAddItem, categoriesData, paymentData }) => {
    ...
    useEffect(() => {
        if(singleAddItem) {
            setDesc(singleAddItem?.description);
            setCategory(singleAddItem?.expense_category)
        }
    }, [showEditExpense, singleAddItem])
    ...
    return (
        <Modal show={showEditExpense} onHide={handleEditClose} centered className="modalExpense">
            <Modal.Body>
                <span className="crossBtnModal" onClick={handleEditClose}> </span>
                <div className="wraper_add_modal">
                    <h2> <span className="plusAdd"></span> Edit </h2>
                    ...
                    <div className="wrape_cl">
                        ...
                        <div className="wraper_dateExpense">
                            ...
                            <DatePicker id={"openDate"} placeholder="Select Start" value={selectedDate}  name='dob' onChange={handleDateChange} />
                        </div>
                    </div>
