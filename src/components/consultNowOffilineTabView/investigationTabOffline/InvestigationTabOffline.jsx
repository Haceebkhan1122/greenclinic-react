    ...
    return (
        <>
            ...
            <div className='investigationTabOffline'>
                ...
                <UploadImageModal getCurrentLab={getCurrentLab} uploadImageShow={uploadImageShow} investigationName={investigationName} note={note} investigationId={investigationId} onImageUpload={handleImageUpload} handleUploadImageClose={handleUploadImageClose} appointmentId={appointmentId} clinicId={clinicId} patientId={patientId} />
