...
import "./healthReportPastMedicalHistory.scss"
...
const HealthReportMedications = () => {
    ...
    const [pastMedicalHistoryFilterShow, setPastMedicalHistoryFilterShow] = useState("")
    const handlePastMedicalHistoryFilterClose = () => setPastMedicalHistoryFilterShow(false);
    const handlePastMedicalHistoryFilterShow = () => setPastMedicalHistoryFilterShow(true);
    ...
    const getMedicneReports = async () => {
        try {
            ...
            const url = queryParams.toString()
                ? `/reports/past-medical-history-list?page=${currentPage}&${queryParams.toString()}`
                : `/reports/past-medical-history-list?page=${currentPage}`;
    ...
    async function downloadAPI() {
        fetch(`${baseUrl}/reports/past-medical-history-download`, {
            method: 'GET',
            headers: {
            ...
            .then((data) => {
                ...
                a.href = fileUrl;
                a.download = "past-medical.csv"; // Ensure CSV format
    ...
    return (
        <WraperLayout>
            <div className="healthReport_medication">
                ...
                {isMobile ?
                    <>
                        <div className="wrapePrint" onClick={handlePastMedicalHistoryFilterShow}>
                                            ...
                                            <Accordion.Body>
                                                <ul className="servicesTotal">
                                                    ...
                                                    <li className='appointmetList'>
                                                        <h5 className='keyTitle '>  Doctor Name </h5>
                                                        <span className="keyBody vitalName"> {item?.doc_name} </span>
                                                    </li>

                                                    <li className='appointmetList'>
                                                        <h5 className='keyTitle '>Age</h5>
                                                        <span className="keyBody vitalName"> {item?.age} </span>
                                                    </li>
                                                    <li className='appointmetList'>
                                                        <h5 className='keyTitle '>Gender </h5>
                                                        <span className="keyBody vitalName"> {item?.gender} </span>
                                                    </li>
                                                    <li className='appointmetList'>
                                                        <h5 className='keyTitle '>Diagnosis </h5>
                                                        <span className="keyBody vitalName"> {item?.past_medical_histoy} </span>
                                                    </li>
                    ...
                    <>
                        ...
                        <div className="table__wrape tablePrime">
                                ...
                                {filteredData?.length > 0 && filteredData?.map((item) => {
                                    return (<>
                                        <tr>
                                            ...
                                            <td> {item?.age} </td>
                                            <td> {item?.gender} </td>
                                            <td> {item?.past_medical_histoy} </td>
                                        </tr>
                                    </>)
                                })}
                                <tbody>
                            ...
                            {!filteredData?.length > 0 && (
                                <div className='text-center d-flex align-items-center justify-content-center'>No data found.</div>
                            )}
                            <div className='pagination_hk'>
                                {totalPages > 1 ? (
                                    <>
                ...
                <Modal handleDateChange={handleDateChange} show={pastMedicalHistoryFilterShow} onHide={handlePastMedicalHistoryFilterClose} centered className="mobileFilterReportModal">
                    <Modal.Body>
                        <span className="crossBtnModal" onClick={handlePastMedicalHistoryFilterClose}></span>
