...
import "./healthReportReasonVisit.scss"
...
const HealthReportMedications = () => {
    ...
    const [visitReasonFilterShow, setVisitReasonFilterShow] = useState("")
    const handleVisitReasonFilterClose = () => setVisitReasonFilterShow(false);
    const handleVisitReasonFilterShow = () => setVisitReasonFilterShow(true);
    ...
    const getMedicneReports = async () => {
        try {
            ...
            const url = queryParams.toString()
                ? `/reports/reason-for-visit-list?page=${currentPage}&${queryParams.toString()}`
                : `/reports/reason-for-visit-list?page=${currentPage}`;
    ...
    async function downloadAPI() {
        fetch(`${baseUrl}/reports/reason-for-visit-download`, {
            method: 'GET',
            headers: {
            ...
            .then((data) => {
                ...
                a.href = fileUrl;
                a.download = "reason-for-visit.csv"; // Ensure CSV format
    ...
    return (
        <WraperLayout>
            <div className="healthReport_medication">
                        ...
                        <Row className='align-items-center'>
                            <Col lg={12}>
                                <div className='heading'>
                                    <button className='back dd' onClick={() => navigate(location.state?.from || "/reports", { state: { activeTab: "5" } })}>
                ...
                {isMobile ?
                    <>
                        <div className="wrapePrint" onClick={handleVisitReasonFilterShow}>
                                            ...
                                            <Accordion.Body>
                                                <ul className="servicesTotal">
                                                    ...
                                                    <li className='appointmetList'>
                                                        ...
                                                        <span className="keyBody vitalName"> {item?.reason} </span>
                                                    </li>
                    ...
                    <>
                        ...
                        <div className="top-bar-filter">
                            <button className='downloadBttn' onClick={() => downloadAPI()}>
                ...
                <Modal handleDateChange={handleDateChange} show={visitReasonFilterShow} onHide={handleVisitReasonFilterClose} centered className="mobileFilterReportModal">
                    <Modal.Body>
                        <span className="crossBtnModal" onClick={handleVisitReasonFilterClose}></span>
