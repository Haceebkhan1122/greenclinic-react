...
import "./healthReportProcedures.scss"
...
const HealthReportMedications = () => {
    ...
    const [procedureFilterShow, setProcedureFilterShow] = useState("")
    const handleProcedureFilterClose = () => setProcedureFilterShow(false);
    const handleProcedureFilterShow = () => setProcedureFilterShow(true);
    ...
    const getMedicneReports = async () => {
        try {
            ...
            const url = queryParams.toString()
                ? `/reports/procedure-list?page=${currentPage}&${queryParams.toString()}`
                : `/reports/procedure-list?page=${currentPage}`;
    ...
    async function downloadAPI() {
        fetch(`${baseUrl}/reports/procedure-download`, {
            method: 'GET',
            headers: {
            ...
            .then((data) => {
                ...
                a.href = fileUrl;
                a.download = "procedures.csv"; // Ensure CSV format
    ...
    return (
        <WraperLayout>
            <div className="healthReport_medication">
                ...
                {isMobile ?
                    <>
                        <div className="wrapePrint" onClick={handleProcedureFilterShow}>
                                                ...
                                                <div className='accordHeader tw-w-full tw-flex tw-items-center tw-justify-between'>
                                                    <div className='tw-flex tw-w-full  tw-flex-col tw-justify-center'>
                                                        <div className=' tw-w-full tw-flex tw-items-center tw-justify-between tw-gap-1'>
                                                            <h5>  {item?.name}</h5>
                                                            <span className="priceTag"> S.No {item?.s_nos}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </Accordion.Header>
                                            <Accordion.Body>
                                                <ul className="servicesTotal">
                                                    ...
                                                    <li className='appointmetList'>
                                                        <h5 className='keyTitle '>  Amount </h5>
                                                        <span className="keyBody vitalName"> {item?.amount} </span>
                                                    </li>
                                                    <li className='appointmetList'>
                                                        <h5 className='keyTitle '>Discount </h5>
                                                        <span className="keyBody vitalName"> {item?.discount} </span>
                                                    </li>
                                                    <li className='appointmetList'>
                                                    ...
                                                    <li className='appointmetList'>
                                                        <h5 className='keyTitle '>No. of the time prescribed </h5>
                                                        <span className="keyBody vitalName"> {item?.nos_prescribed} </span>
                                                    </li>
                    ...
                    <>
                        ...
                        <Form.Select aria-label="Default select example" name='dataType' onChange={handleChange}>
                            <option value={""}>Select Vendor</option>
                            <option value={1}>data demo</option>
                            <option value={2}>data demo1</option>
                        </Form.Select>
                    </div> */}
                ...
                <Modal handleDateChange={handleDateChange} show={procedureFilterShow} onHide={handleProcedureFilterClose} centered className="mobileFilterReportModal">
                    <Modal.Body>
                        <span className="crossBtnModal" onClick={handleProcedureFilterClose}></span>
