...
const LetterHead = ({selectedPageType, setSelectedPageType, errorObj, printSettings, inputVall,marginTop, setMarginTop,marginBottom,setMarginBottom,marginLeft,setMarginLeft,marginRight,setMarginRight }) => {

    const handleChange = (e) => {
        const {value, name, checked} = e.target;
        if(name == "page") {
            if(checked) {
                setSelectedPageType("letterhead")
            }
        }
    }
            ...
            <div className='letter_head'>
                <div className="single customRadioo">
                    <div className="wrapeInp">
                        <input type="radio" value={"letterhead"} id="custom" name="page"  onChange={handleChange} defaultChecked={!printSettings?.selected_template?.type ? selectedPageType == "letterhead" ? true : false : printSettings?.selected_template?.type == "letterhead" ? true : false }  />
                        <span></span>
                    </div>
